...
- **i-4 — React migration decision** for `index-db.html` (currently vanilla-JS template MVC). Scoping docs already exist (`docs/.impl_plans/0.9.0_20260903-082033_frontend-scope-*.md`); explicitly pending owner approval, not started.
